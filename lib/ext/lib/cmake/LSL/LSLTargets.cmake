...
set_target_properties(LSL::lsl PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<IF:\$<BOOL:OFF>,LIBLSL_STATIC,LIBLSL_EXPORTS>"
...
set_target_properties(LSL::lslobj PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:LSL::lslboost>;\$<LINK_ONLY:\$<\$<PLATFORM_ID:Windows>:iphlpapi>>;\$<LINK_ONLY:\$<\$<PLATFORM_ID:Windows>:winmm>>;\$<\$<AND:\$<BOOL:OFF>,\$<PLATFORM_ID:Linux>>:dl>;\$<\$<BOOL:>:rt>"
)
...
set_target_properties(LSL::lslboost PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Threads::Threads;\$<LINK_ONLY:\$<\$<PLATFORM_ID:Windows>:bcrypt>>;\$<LINK_ONLY:\$<\$<PLATFORM_ID:Windows>:mswsock>>;\$<LINK_ONLY:\$<\$<PLATFORM_ID:Windows>:ws2_32>>"
)
